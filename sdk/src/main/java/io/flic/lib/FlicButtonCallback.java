...
public class FlicButtonCallback {
   ...
   */
  public void onConnectionStarted(@NonNull final FlicButton button) {
  }
   ...
   */
  public void onConnectionFailed(@NonNull final FlicButton button, int status) {
  }
   ...
   * @param button The button
   */
  public void onDisconnect(@NonNull final FlicButton button) {
  }
   ...
   * @param button The button
   */
  public void onConnectionCompleted(@NonNull final FlicButton button) {
  }
   ...
   */
  public void onReadRemoteRSSI(@NonNull final FlicButton button, int rssi, int status) {
  }
   ...
   */
  public void onButtonUpOrDown(@NonNull final FlicButton button, boolean wasQueued, int timeDiff, boolean isUp, boolean isDown) {
  }
   ...
   */
  public void onButtonClickOrHold(@NonNull final FlicButton button, boolean wasQueued, int timeDiff, boolean isClick, boolean isHold) {
  }
   ...
   */
  public void onButtonSingleOrDoubleClick(@NonNull final FlicButton button, boolean wasQueued, int timeDiff, boolean isSingleClick, boolean isDoubleClick) {
  }
   ...
   * @param isHold        True if hold, else false
   */
  public void onButtonSingleOrDoubleClickOrHold(@NonNull final FlicButton button, boolean wasQueued, int timeDiff, boolean isSingleClick, boolean isDoubleClick, boolean isHold) {
  }
   ...
   * @param button The button
   */
  public void onButtonRemoved(@NonNull final FlicButton button) {
  }
}
